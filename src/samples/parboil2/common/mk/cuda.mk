...
run:
	...
	@echo "$(BENCHMARKDIR) | $(PWD) | $(BIN) | $(SRCDIR) | $(BUILDDIR) | $(PARBOIL_ROOT) | $(PLATFORM) | $(BUILD)"
	$(shell echo $(RUNTIME_ENV)) LD_LIBRARY_PATH=$(CUDA_LIB_PATH) ldd $(BENCHMARKDIR)/$(BIN) | grep cuda
	$(shell echo $(RUNTIME_ENV)) LD_LIBRARY_PATH=$(CUDA_LIB_PATH) $(BENCHMARKDIR)/$(BIN) $(ARGS)
